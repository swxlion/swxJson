	...
	{
		{
			...
			} catch (const JsonError& ex) { cout<<"[Error Testing] want string at node aaa.bbb.real error: "<<ex.what()<<endl; }

			try{
				cout<<node.wantString("aaa.bbb.int")<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want string at node aaa.bbb.int error: "<<ex.what()<<endl; }
			try{
			...
			} catch (const JsonError& ex) { cout<<"[Error Testing] want bool at node aaa.bbb.int error: "<<ex.what()<<endl; }
			try{
				cout<<node.wantInt("aaa.bbb.string")<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want int at node aaa.bbb.string error: "<<ex.what()<<endl; }
			try{
				cout<<node.wantReal("aaa.bbb.string")<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want real at node aaa.bbb.string error: "<<ex.what()<<endl; }
...

		{
			...
			} catch (const JsonError& ex) { cout<<"[Error Testing] want bool vector at node demo.array.int error: "<<ex.what()<<endl; }
			try{
				tmp = node.getNode("demo.array.string");
				std::vector<double> vd = tmp->wantRealVector(); printVector("demo.array.string", vd);
			} catch (const JsonError& ex) { cout<<"[Error Testing] want real vector at node aaa.bbb.string error: "<<ex.what()<<endl; }
			try{
				tmp = node.getNode("demo.array.string");
				std::vector<intmax_t> vi = tmp->wantIntVector(); printVector("demo.array.string", vi);
			} catch (const JsonError& ex) { cout<<"[Error Testing] want int vector at node aaa.bbb.string error: "<<ex.what()<<endl; }
			try{
				tmp = node.getNode("demo.array.int");
				std::vector<std::string> vs = tmp->wantStringVector(); printVector("demo.array.int", vs);
			} catch (const JsonError& ex) { cout<<"[Error Testing] want string vector at demo.array.int error: "<<ex.what()<<endl; }

			try{
				tmp = node.getNode("demo.dict.int");
				std::map<std::string, bool> mb = tmp->wantBoolDict(); printMap("demo.dict.int", mb);
			} catch (const JsonError& ex) { cout<<"[Error Testing] want bool map at node aaa.bbb.int error: "<<ex.what()<<endl; }
			try{
				tmp = node.getNode("demo.dict.string");
				std::map<std::string, double> md = tmp->wantRealDict(); printMap("demo.dict.string", md);
			} catch (const JsonError& ex) { cout<<"[Error Testing] want real map at node aaa.bbb.string error: "<<ex.what()<<endl; }
			try{
				tmp = node.getNode("demo.dict.string");
				std::map<std::string, intmax_t> mi = tmp->wantIntDict(); printMap("demo.dict.string", mi);
			} catch (const JsonError& ex) { cout<<"[Error Testing] want int map at node aaa.bbb.string error: "<<ex.what()<<endl; }
			try{
				tmp = node.getNode("demo.dict.int");
				std::map<std::string, std::string> ms = tmp->wantStringDict(); printMap("demo.dict.int", ms);
			} catch (const JsonError& ex) { cout<<"[Error Testing] want string map at node aaa.bbb.int error: "<<ex.what()<<endl; }
		}

		{
			try{
				std::vector<bool> vb = node.wantBoolVector("demo.array.int"); printVector("demo.array.int", vb);
			} catch (const JsonError& ex) { cout<<"[Error Testing] want bool vector at node aaa.bbb.int error: "<<ex.what()<<endl; }
			try{
			...
			} catch (const JsonError& ex) { cout<<"[Error Testing] want string vector at node aaa.bbb.int error: "<<ex.what()<<endl; }
			...
			} catch (const JsonError& ex) { cout<<"[Error Testing] want inr map at node aaa.bbb.string error: "<<ex.what()<<endl; }
			try{
...

		{
			...
			} catch (const JsonError& ex) { cout<<"[Error Testing] want float at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			try{
				double d = node["demo.idx.bool"];        cout<<"node demo.idx.bool (double) is "<<d<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want double at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			try{
				long double ld = node["demo.idx.bool"];  cout<<"node demo.idx.bool (long double) is "<<ld<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want long double at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			try{
				string str = node["demo.idx.bool"];    cout<<"node demo.idx.bool is "<<str<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want string at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			
			try{
				short s = node["demo.idx.bool"];                 cout<<"node demo.idx.bool (short) is "<<s<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want short at node aaa.bbb.string error: "<<ex.what()<<endl; }
			try{
				unsigned short us = node["demo.idx.bool"];       cout<<"node demo.idx.bool (ushort) is "<<us<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want ushort at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			try{
				int i = node["demo.idx.bool"];                   cout<<"node demo.idx.bool (int) is "<<i<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want int at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			try{
				unsigned int ui = node["demo.idx.bool"];         cout<<"node demo.idx.bool (uint) is "<<ui<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want uint at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			try{
				long l = node["demo.idx.bool"];                  cout<<"node demo.idx.bool (long) is "<<l<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want long at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			try{
				unsigned long ul = node["demo.idx.bool"];        cout<<"node demo.idx.bool (ulong) is "<<ul<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want ulong at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			try{
				long long ll = node["demo.idx.bool"];            cout<<"node demo.idx.bool (longlong) is "<<ll<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want long long at node aaa.bbb.bool error: "<<ex.what()<<endl; }
			try{
				unsigned long long ull = node["demo.idx.bool"];  cout<<"node demo.idx.bool (ulonglong) is "<<ull<<endl;
			} catch (const JsonError& ex) { cout<<"[Error Testing] want ulonglong at node aaa.bbb.bool error: "<<ex.what()<<endl; }
		}
	}
