...
public:
	...
	operator unsigned int() const throw(JsonNodeTypeMissMatchError)       { return (unsigned int)      wantInt(); }
	operator long() const throw(JsonNodeTypeMissMatchError)               { return (long)              wantInt(); }
	operator unsigned long() const throw(JsonNodeTypeMissMatchError)      { return (unsigned long)     wantInt(); }
	operator long long() const throw(JsonNodeTypeMissMatchError)          { return (long long)         wantInt(); }
	operator unsigned long long() const throw(JsonNodeTypeMissMatchError) { return (unsigned long long)wantInt(); }
